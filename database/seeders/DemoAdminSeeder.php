 ...
 * equivalent: a throwaway login with a password in the repository, which is
 * exactly why it refuses to run anywhere but `local` and refuses to touch an
 * account that already exists.
 */
class DemoAdminSeeder extends Seeder
{
    public const EMAIL = 'demo@my-page.test';

    /** In the repository on purpose. Never reuse it for anything real. */
    public const PASSWORD = 'demo-workspace';
